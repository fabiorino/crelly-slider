(function($) {
	$(window).load(function() {
		...
		$('.cs-admin .cs-slider .cs-save-settings').click(function(e) {
			// Prevent scroll jump
			e.preventDefault();

			// Scroll back to top smoothly to preview the message
		...
		// Enable slider settings toggle
		$( '.cs-table:not(.cs-sliders-list) thead' ).live( 'click', function() {
